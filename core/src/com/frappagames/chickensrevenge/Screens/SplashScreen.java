...
public class SplashScreen implements Screen {
    private final ChickensRevenge game;
    ...
    public SplashScreen(ChickensRevenge gameApp) {
        this.game = gameApp;
        ...
        camera.setToOrtho(false, ChickensRevenge.WIDTH, ChickensRevenge.HEIGHT);

        Image splashImage = new Image(splashTexture);
        stage.addActor(splashImage);
        splashImage.setX((ChickensRevenge.WIDTH / 2) - (splashImage.getWidth() / 2));
        splashImage.setY((ChickensRevenge.HEIGHT / 2) - (splashImage.getHeight() / 2));
