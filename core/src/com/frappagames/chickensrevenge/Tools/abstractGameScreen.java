...
public abstract class abstractGameScreen implements Screen {
    ...
    protected       ChickensRevenge    game;
    private         Stage              stage;
    protected       Table              table;

    protected Texture background;

    public abstractGameScreen(ChickensRevenge game) {
        this.game = game;
        camera = new OrthographicCamera();
        camera.position.set(ChickensRevenge.WIDTH / 2, ChickensRevenge.HEIGHT / 2, 0);
        viewport = new FitViewport(ChickensRevenge.WIDTH, ChickensRevenge.HEIGHT, camera);
